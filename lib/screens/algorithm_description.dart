...
class DescriptionAlgorithmFramework extends StatefulWidget {
  final String result;

  const DescriptionAlgorithmFramework({required this.result, super.key});

  @override
  DescriptionAlgorithmInterface createState() =>
      DescriptionAlgorithmInterface();
}

class DescriptionAlgorithmInterface
    extends State<DescriptionAlgorithmFramework> {
  ...
  Future<void> loadDescription() async {
    try {
      String csvPath = "assets/explanations.csv"; // Path to my CSV file
